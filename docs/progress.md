...
| 6 | MVP Hardening for Low-cost Host | In Progress | 2026-02-23 | - | OAuth Phase 6.1 implemented (web + WhatsApp command flow) and OpenAI Responses chat wiring added (OAuth-first, API key fallback). Remaining: retention, backup reminders, CI, performance tuning. |
