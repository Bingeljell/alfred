...
async function main(): Promise<void> {
  ...
  const app = createGatewayApp(store, {
    ...
    capabilityPolicy: {
      ...
      fileReadEnabled: config.alfredFileReadEnabled,
      fileReadAllowedDirs: config.alfredFileReadAllowedDirs,
      ...
      fileEditEnabled: config.alfredFileEditEnabled,
      fileEditRequireApproval: config.alfredFileEditRequireApproval,
      fileEditAllowedDirs: config.alfredFileEditAllowedDirs,
