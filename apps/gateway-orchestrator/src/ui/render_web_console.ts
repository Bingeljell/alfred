  ...
  <body>
    ...
    <main class="layout">
      <section class="panel">
        ...
        <div class="hint">Quick commands: <span class="pill">/task add ...</span><span class="pill">/note add ...</span><span class="pill">/remind &lt;ISO&gt; ...</span><span class="pill">/web --provider=brave ...</span><span class="pill">/auth connect</span><span class="pill">/auth status</span><span class="pill">/auth limits</span><span class="pill">/approval pending</span><span class="pill">send ...</span><span class="pill">yes / no</span><span class="pill">approve &lt;token&gt;</span><span class="pill">reject &lt;token&gt;</span></div>
